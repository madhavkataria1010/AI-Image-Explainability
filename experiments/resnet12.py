...
batch_size = 128
num_epochs = 100
save_best_path = './models/resnet12_best.pt'
save_path = './models/resnet12_final.pt'
log_file = './logs/resnet12.json'
patience = 10
...
"""
    Fine-tuned Resnet 12 model on our training dataset with custom head to meet our requirements of binary classification
"""
from resnet12.Resnet12 import Resnet12

class ResNet12Classifier(nn.Module):
    def __init__(self, num_classes=2, keep_prob=1.0, avg_pool=True, drop_rate=0.1, drop_block=True, dropblock_size=1):
        super(ResNet12Classifier, self).__init__()
...
model = ResNet12Classifier(num_classes=2)
