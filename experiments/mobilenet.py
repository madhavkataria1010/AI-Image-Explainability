...
batch_size = 128
num_epochs = 100
save_best_path = './models/mobilenetv3_best.pt'
save_path = './models/mobilenetv3_final.pt'
log_file = './logs/mobilenetv3.json'
patience = 10
...
"""
    Fine-tuned Mobilenet v3 model on our training dataset with custom head to meet our requirements of binary classification
"""
