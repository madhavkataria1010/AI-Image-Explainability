...
batch_size = 512
num_epochs = 100
save_best_path = './models/resnet50_best.pt'
save_path = './models/resnet50_final.pt'
log_file = './logs/resnet50.json'
patience = 10
...
"""
    Fine-tuned Resenet 50 model on our training dataset with custom head to meet our requirements of binary classification
"""
model = models.resnet50(weights=models.ResNet50_Weights.DEFAULT)
num_classes = 2
model.fc = nn.Linear(model.fc.in_features, num_classes)  # Change the final layer to output 2 classes
model.to(device)
