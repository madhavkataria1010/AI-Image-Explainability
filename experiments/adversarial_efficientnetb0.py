...
batch_size = 64
num_epochs = 100
save_best_path = './models/adversarial_efficientnet_b0_best.pt'
save_path = './models/adversarial_efficientnet_b0_final.pt'
log_file = './logs/adversarial_efficientnet_b0.log'
patience = 10
...
"""
    Fine-tuned Efficient Net b0 model on our training dataset 
"""
...
for epoch in range(num_epochs):
    ...
    for images, labels, _ in val_loader:
        ...
        attack = random.choice([FGSM(model, eps=8/255), PGD(model, eps=6/255, alpha=2/255, steps=5)])
        ...
        with autocast('cuda'):
            ...
            kl_loss = dkl_loss(clean_logits, adv_logits, weight=1.1, alpha=1.5, beta=12)

            outputs = model(images)
            loss = kl_loss + clean_loss
