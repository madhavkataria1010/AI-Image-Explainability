...
batch_size = 512
num_epochs = 100
save_best_path = './models/resnet18_best.pt'
save_path = './models/resnet18_final.pt'
log_file = './logs/resnet18.json'
patience = 10
...
"""
    Fine-tuned Resenet 18 model on our training dataset with custom head to meet our requirements of binary classification
"""
